...
inspectorHAMMER = cms.EDProducer(
    'inspectorHAMMER',
...
print(inspectorHAMMER.dumpPython)

#BsToDsPhiKKPiMuVariables.extend(vertexVariables)
combined_variablesHAMMER = cms.PSet(
  inspectorVariables,
  hammerVariables
)
  
inspectorHAMMERTable = cms.EDProducer('SimpleCompositeCandidateFlatTableProducer',

    src = cms.InputTag("inspectorHAMMER:genHAMMER"),
    cut = cms.string(""),
    name = cms.string("genHAMMER"),
    doc  = cms.string("inspectorHAMMER"),
    singleton = cms.bool(False), # the number of entries is variable
    extension = cms.bool(False), 
    variables = combined_variablesHAMMER

)

#tables = cms.Sequence(BsToDsPhiKKPiMuTable) # * vertexTable)
inspectorHAMMERSequence = cms.Sequence(inspectorHAMMER + inspectorHAMMERTable)
